...
<header id="top">
    ...
    <div class="rt">
        <ul class="lf">
            ...
            <li><a href="queryall.do" >购物车</a><b>|</b></li>
            ...
            <%
            	...
            	if(user!=null){
            %>
            <a href="#"><%=user.getUname() %></a><b>|</b>
            <a href="exit.do">退出</a><b>|</b>
            <%}else{ %>
            	<a href="login.jsp">登录</a><b>|</b>
            <%} %>
            </li>
...
<div class="store">
	...
	<div class="store_content">
		<c:forEach items="${pageBean.listBean}" var="list">
			<div>
	            <a href="detail.do?isbn=${list.isbn}&user_id=${user.phone}"><img src="../img/goods/${list.isbn}/index.jpg" alt=""/></a>
	...
	<p style="text-align: center;">
		...
		<input type="button" value="Go" onclick="trun();">
	</p>
<!-- 品质保障，私人定制等-->
<div id="foot_box">
    <div class="icon1 lf">
