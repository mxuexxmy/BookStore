...
<div id="shop_detail">
    ...
    <div class="right_detail lf">
        ...
        <!-- 购买部分-->
        <div class="shops">
            <a onclick="buyNow();" class="buy lf" id="buy_now">立即购买</a>
            <a onclick="addCart();" class="shop lf" id="add_cart"><img src="../img/product_detail/product_detail_img7.png" alt=""/>加入购物车</a>
            <a onclick="collect();" class="collection lf" id="collect">
            <span>收藏</span></a><b>
