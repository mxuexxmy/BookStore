    ...
    <section id="section" >
        ...
        <div id="box" >
            <div id="content_box">
				...
				<c:forEach items="${list}" var="cartDetail">
						<div class="imfor">
                    <div class="check">
                        <div class="Each">
                            <span class="normal">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="1">
                            <img src="../img/goods/${cartDetail.isbn}/detail1.jpg" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                         ${cartDetail.title}
                              <input type="hidden" name="" value="">
                        </span>
                            <p class="collf"><span>作者：</span><span class="color_des">${cartDetail.author}<input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des"></p>
                        <p class="pices_information"><b>￥</b><span>${cartDetail.price}<input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cartDetail.count}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cartDetail.price*cartDetail.count}</span>
                    </div>
                    <div class="del">
                        <a onclick="deleteCart(${cartDetail.isbn});" class="del_d">删除</a>
                    </div>
                </div>
				</c:forEach>
...
<script>
    ...
    function deleteCart(val) {
		var result = window.confirm("是否确认删除宝贝？");
		if(result){
			window.location.href="deleteCart.do?product="+val;
		}
	}
</script>
</body>
